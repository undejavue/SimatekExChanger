...
namespace ClassLibOracle
{
    ...
    public partial class OraContext : DbContext
    {
        ...
        public virtual int RUN_PROC_GUILD_OPC(string iNS_G_UCHASTOK, int iNS_N_STAN, bool iNS_START_STOP, bool iNS_ERASE, bool iNS_BREAK, bool iNS_REPLAC, int iNS_COUNTER, DateTime iNS_INCOMIN_DATE)
        {
            ...
            ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PROC_GUILD_MILL_OPC", iNS_G_UCHASTOKParameter, iNS_N_STANParameter, iNS_START_STOPParameter, iNS_ERASEParameter, iNS_BREAKParameter, iNS_REPLACParameter, iNS_COUNTERParameter, iNS_INCOMIN_DATEParameter, retOut);
        ...
        //public virtual int PROC_GUILD_MILL_OPC(string iNS_G_UCHASTOK, Nullable<decimal> iNS_N_STAN, Nullable<decimal> iNS_START_STOP, Nullable<decimal> iNS_ERASE, Nullable<decimal> iNS_BREAK, Nullable<decimal> iNS_REPLAC, Nullable<decimal> iNS_COUNTER, Nullable<System.DateTime> iNS_INCOMIN_DATE, ObjectParameter rET_OUT)
        //{
        ...
        //    return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PROC_GUILD_MILL_OPC", iNS_G_UCHASTOKParameter, iNS_N_STANParameter, iNS_START_STOPParameter, iNS_ERASEParameter, iNS_BREAKParameter, iNS_REPLACParameter, iNS_COUNTERParameter, iNS_INCOMIN_DATEParameter, rET_OUT);
        //}
    }
}
